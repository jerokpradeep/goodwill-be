...
import in.codifi.api.controller.spec.AdvanceMWControllerSpec;
...
@Path("/test")
public class AdvanceMWController implements AdvanceMWControllerSpec {
	@Inject
	AppUtil appUtil;
	@Inject
	...
	@Inject
	AdvanceMWServiceSpec advanceMWService;
