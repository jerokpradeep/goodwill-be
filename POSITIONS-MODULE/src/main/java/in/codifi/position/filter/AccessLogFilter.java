package in.codifi.position.filter;
...
import in.codifi.position.entity.logs.AccessLogModel;
		...
		pool.execute(new Runnable() {
			...
			public void run() {
				try {
					...
					accLogModel.setModule(AppConstants.MODULE_POSITIONS);
					...
					accLogModel.setDomain(headers.getFirst(AppConstants.HOST));
