...
public class HazelcastConfig {
	...
	private Map<String, String> restUserSessionKB = getHz().getMap("restUserSessionKB");

	private Map<String, Long> otpMailSettingsKB = getHz().getMap("otpMailSettingsKB");
	private Map<String, GetIntroSpectResponse> keycloakUserInfoKB = getHz().getMap("keycloakUserInfoKB");
